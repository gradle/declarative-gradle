 ...
 */
@Restricted
public abstract class StandaloneAndroidLibrary implements AndroidLibrary {
    private final AndroidLibraryDependencies dependencies;
    private final AndroidTargets targets;

    @Inject
    public StandaloneAndroidLibrary(AndroidTargets targets, ObjectFactory objectFactory) {
